...
int main() {
    simple_tree<char> s1;
    simple_tree<char>* root = new simple_tree<char>('M');
    /*simple_tree<char>* o = new simple_tree<char>('o');
    simple_tree<char>* i = new simple_tree<char>('i');
    simple_tree<char>* z = new simple_tree<char>('z');*/
    root->insert('o');
    root->insert('i');
    root->insert('z');
